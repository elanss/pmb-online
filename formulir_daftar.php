...
$q_kop = mysql_query("SELECT * FROM t_universitas WHERE admin = 'admin'");
	...
	<body onload="print();">
		<table class="cetak">
			<tr style="border-bottom: solid 4px">
				<td><img src="images/logo/<?php echo $a_kop[4]; ?>" width="100px" height="100px"></td>
				<td align="center">
			...
			<tablE class="data" width="80%" align="center">
				...
				echo "<tr><th colspan='2'>Data Calon Mahasiswa</th></tr>";
				cFDfield("NISN", $a[43]);
				cFDfield("Nama", $a[1]);
