...
function getUniversitas() {
	$q = mysql_query("SELECT * FROM t_universitas WHERE flag = '1'");
	$a = mysql_fetch_array($q);
	
	$dataUniversitas = array();
	$dataUniversitas[0] = $a[0];
	$dataUniversitas[1] = $a[1];
	$dataUniversitas[2] = $a[2];
	$dataUniversitas[3] = $a[3];
	$dataUniversitas[4] = $a[4];
	$dataUniversitas[5] = $a[5];
	
	return $dataUniversitas;
}
