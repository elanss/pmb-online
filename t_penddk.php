...
<article class="module width_full">
	<header><h3>Referensi Pendidikan</h3></header>
		...
		<?php		
		// ================ TAMPILKAN DATANYA =====================//
		echo "<table border='1' class='data'><tr><th width='10%'>ID</th><th width='60%'>Pendidikan</th><th width='30%'>Kontrol</th></tr>";
		...
		if ($j_data == 0) {
			...
			while ($a_penddk = mysql_fetch_array($q_penddk)) {
				...
				<td id='tengah'><a href='?p=t_penddk&mod=edit&id=$a_penddk[0]'>Ubah</a> |
					<a href='?p=t_penddk&mod=del&id=$a_penddk[0]' onclick=\"return konfirmasi('Menghapus data $a_penddk[1]')\">Hapus</a>
				</tr>";
				$no++;
			}
		}
